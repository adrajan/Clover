...
//                });
        ...
        mOrderUpdateListener = new OrderV31Connector.OnOrderUpdateListener2() {
            ...
            public void onPaymentProcessed(String orderId, String paymentId) {
                Log.d("Main Activity", "orderId " +orderId);
                Log.d("Main Activity", "paymentId " +paymentId);

                Intent intent = new Intent(OrderListenerService.this, PaymentProcessedActivity.class);
//                intent.putExtra("clover.intent.extra.TARGET_DEVICE", "CLOVER_CFT");
                intent.putExtra("ORDER_ID", orderId);
                intent.putExtra("PAYMENT_ID", paymentId);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK); // Required for starting activity from a service
